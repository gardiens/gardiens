...
My name is Pierrick Bournez, and I am currently pursuing a PhD focused on multimodal large language models for anomaly detection.
...
- **Deep Learning engineer at [Laboratoire interdisciplinaire du numérique ](https://www.lisn.upsaclay.fr/)** 🧑: Time series Transformers for human skeleton forecasting, we published [a paper](https://github.com/gardiens/Time-Series-Library_skeleton/blob/master/9_Investigating_Transformers_f.pdf) at a Junior conference !   - *2 months*
- **Student at [*CentraleSupélec*](https://www.centralesupelec.fr/) and [MVA](https://www.master-mva.com/)** :man_student:: top 3 french Engineer School (Deep Learning lessons and many more) - *3 years*
